...
public class WeaponSelectionTests : BaseTestFixture
{
    ...
    {
        Assert.That(Queries.GetUserSettings(1)?.GetWeaponPreference(CsTeam.Terrorist, WeaponAllocationType.FullBuyPrimary),
            Is.EqualTo(null));
        ...
        Assert.That(Queries.GetUserSettings(1)?.GetWeaponPreference(CsTeam.CounterTerrorist, WeaponAllocationType.HalfBuyPrimary),
            Is.EqualTo(null));
